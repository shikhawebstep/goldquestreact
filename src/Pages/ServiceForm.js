        ...
        <>
            <form action="" className="" onSubmit={handleSubmit}>
                ...
                <div className="mb-4">
                    ...
                    <select name="" id=" "className='outline-none pe-14 ps-2 text-left rounded-md w-full border p-2 mt-2'>
                        <option value="">Packages1</option>
                        <option value="">Packages2</option>
                        <option value="">Packages3</option>
                        <option value="">Packages4</option>
