                        ...
                        <React.Fragment key={index}>
                            <tr>
                                <td className="py-3 px-4 border-b border-r-2 whitespace-nowrap">
                                    <input type="checkbox" className="me-2" />{item.sl}
                                </td>
                                ...
                                <td className="py-3 px-4 border-b border-r-2 whitespace-nowrap">
                                    <button
                                        className="bg-green-500 rounded-md p-3 text-white"
                            ...
                            {expandedRows.includes(index) && (
                                <tr>
                                    <td colSpan="9" className="p-0">
                                        <div className="collapseMenu overflow-x-auto">
                                            <table className="min-w-full bg-gray-100">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td className="py-3 px-4 border-b whitespace-nowrap">{item.locationname}</td>
                                                    </tr>
                                                    <tr>
...
export default ExcelTrackerStatus;
